...
class ObservationSevenScreen extends Component {
  state = {
    filePath: ""
  };
  ...
  handleNextButton = () => {
    ...
    const filterObservationData = temporaryData.observation.filter(
      observation => observation.screen_number !== "7"
    );
